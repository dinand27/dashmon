...
<?= $this->include('layout/navbar') ?>
	...
	<div class="container mt-3">
		...
		?>
		<form method="post" action="report/simpanExcelDT" enctype="multipart/form-data">
			<div class="form-group">
				<label id="btnImport" style="display: none;"><button class="btn btn-warning" onclick="fnImport()">Import DT</button></label>
			...
			<div class="form-group">
				...
				<!-- <a href="<?php echo base_url('init_report_dt'); ?>" class="btn btn-danger" onclick="fungsiInit()">Delete-Report</a>  -->
